defmodule CatchWeb.RequestControllerTest do
  use CatchWeb.ConnCase

  alias Catch.Requests

  @create_attrs %{body: "some body", content_type: "some content_type", headers: %{}, params: %{}, path: "some path", verb: "some verb"}
